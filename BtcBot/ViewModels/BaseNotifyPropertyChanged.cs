...
namespace BtcBot.ViewModels {
    ...
    public abstract class BaseNotifyPropertyChanged: INotifyPropertyChanged {
        ...
        protected T getProp<T>([CallerMemberName] string propertyName = null) {
            ...
            object value;
            if(_propertyBackingDictionary.TryGetValue(propertyName, out value)) { return (T) value; }
        ...
        protected bool setProp<T>(T newValue, [CallerMemberName] string propertyName = null) {
            ...
            if(EqualityComparer<T>.Default.Equals(newValue, getProp<T>(propertyName))) { return false; }
